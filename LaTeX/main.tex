...
\renewcommand{\maketitle}{%
  ...
  \begin{tikzpicture}[remember picture, overlay]
    % Blue header bar
    \node[anchor=north west, fill=UWABlue, minimum width=\paperwidth, minimum height=7.5cm] 
    ...
    % Main title
    \node[anchor=west, text=white, font=\Huge\bfseries, text width=15cm, inner sep=0pt, align=left]
      at ([xshift=2.5cm, yshift=-2.5cm]current page.north west) {\@title};
    % Author/Institution
    \node[anchor=west, text=white, font=\large, inner sep=0pt, align=left]
      at ([xshift=2.5cm, yshift=-5.5cm]current page.north west) {\@author};
    % Date
    \node[anchor=west, text=white, font=\normalsize, inner sep=0pt, align=left]
      at ([xshift=2.5cm, yshift=-6.5cm]current page.north west) {\@date};
  \end{tikzpicture}
  \vspace*{8.5cm}
}
\makeatother
