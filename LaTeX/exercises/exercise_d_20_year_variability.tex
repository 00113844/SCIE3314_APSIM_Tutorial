...
\begin{itemize}
  \item ✓ Annual yield summary table (20 years)
  \item ✓ Risk metrics (mean, SD, CV, P(Yield $<$ threshold))
  \item ✓ 3+ visualizations (time series, histogram, scatter)
  \item ✓ Dry vs. wet year comparison (phenology, yields)
  \item ✓ Written answers to 7 analysis questions
  \item ✓ Recommendation: Is the current management robust? What adaptation would you propose?
\end{itemize}
