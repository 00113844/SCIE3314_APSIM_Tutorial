...
\midrule
Location & Dalby, Queensland (representative site) \\
...
\begin{itemize}
  \item ✓ Analyzed data (with helper columns for sowing readiness)
  \item ✓ 3+ visualizations (plots as described above)
  \item ✓ Written answers to Analysis Questions (5 items)
  \item ✓ Brief reflection (100--150 words): What surprised you? How would you use this in a real farming decision?
\end{itemize}
