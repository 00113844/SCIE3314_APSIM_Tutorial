...
\begin{itemize}
  \item ✓ Yield summary table (N rate vs. Yield)
  \item ✓ AEN calculations (table with AEN for each N rate)
  \item ✓ N response curve plot
  \item ✓ Profit analysis table + chart
  \item ✓ Protein vs. N rate plot
  \item ✓ Written answers to 7 analysis questions
  \item ✓ Conclusion: Your recommendation for optimal N rate and justification
\end{itemize}
