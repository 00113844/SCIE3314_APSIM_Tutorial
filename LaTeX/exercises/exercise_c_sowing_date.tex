...
\textbf{Location:} Dalby, Queensland
...
\begin{enumerate}
  ...
  \item \textbf{Practical recommendation:} Based on your simulation results for this one season (1949--1950), which sowing date would you recommend to a Dalby wheat farmer? Acknowledge at least one limitation of making this recommendation from a single-season analysis.
\end{enumerate}
