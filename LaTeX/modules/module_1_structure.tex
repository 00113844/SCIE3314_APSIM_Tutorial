...
\begin{forest}
  ...
  [Simulations, fill=UWABlue!22, font=\footnotesize\bfseries\ttfamily
...
\begin{itemize}
  \item \texttt{Clock} — Simulation timing
  \item \texttt{Weather} — Climate input
  \item \texttt{Soil} — Soil profile setup
  \item \texttt{Wheat} — Crop model
  \item \texttt{Manager} — Management rules
  \item \texttt{Report} — Output variables
  \item \texttt{DataStore} — Results database
\end{itemize}
