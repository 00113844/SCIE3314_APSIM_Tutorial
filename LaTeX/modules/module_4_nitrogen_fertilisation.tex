...
\begin{itemize}
  ...
  \item Calculate NUE (Nitrogen Use Efficiency)
...
Run all four; compare yields, grain protein, and NUE.

\section{Nitrogen Use Efficiency}

\[
\text{NUE} = \frac{\text{Yield}_{N \text{ treatment}} - \text{Yield}_{0 \text{ N}}}{\text{N rate}} \quad [\text{kg grain / kg N}]
\]

\begin{keyconceptbox}
\textbf{Interpretation:}
\begin{itemize}
  \item NUE = 15 kg/kg: Every kg of N produces 15 kg of grain
  \item NUE is typically highest at low N rates (diminishing returns)
  \item NUE decreases as N rate increases (physiological limit)
\end{itemize}
\end{keyconceptbox}
...
\begin{enumerate}
  ...
  \item NUE = (Yield$_{N}$ $-$ Yield$_0$) / N rate; typical range 10--16 kg grain/kg N for dryland wheat
