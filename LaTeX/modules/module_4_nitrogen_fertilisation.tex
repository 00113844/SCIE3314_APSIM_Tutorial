...
Typical wheat N response at Dalby (Vertosol, average rainfall):

\begin{center}
\begin{tabular}{r|r|r|r}
\textbf{N Rate (kg/ha)} & \textbf{Yield (kg/ha)} & \textbf{Yield gain (kg/ha)} & \textbf{AEN (kg/kg)} \\
\hline
0   & 1800 & ---  & --- \\
80  & 2960 & 1160 & 14.5 \\
160 & 3780 & 820  & 12.4 \\
...
\begin{itemize}
  ...
  \item Urea (46\% N): \$\approx 1.20--1.60 per kg N (varies with market)
  \item Application cost: \$\approx 15--25 per ha
\end{itemize}
...
Subtropical clay soil (Dalby) & 12--16 & Good N retention; moderate response \\
...
\begin{keyconceptbox}
\textbf{Why Dalby Vertosols respond well to N:}
The black clay (Vertosol) at Dalby has high cation-exchange capacity, which adsorbs NH$_4^+$ and slows leaching. This means applied N stays in the root zone longer, increasing the likelihood of plant uptake rather than loss. AEN on Vertosols is typically higher than on sandy or light-textured soils.
\end{keyconceptbox}
